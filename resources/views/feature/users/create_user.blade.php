                ...
                <div class="d-flex gap-4">
                    <div class="mb-3 w-100">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="john.doe" value="{{ old('email') }}" />
                    ...
                    <div class="mb-3 w-100">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="phone" class="form-control phone-mask @error('phone') is-invalid @enderror" name="phone" placeholder="658 799 8941" value="{{ old('phone') }}" />
                        </div>
                        @error('phone')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                ...
                <div class="d-flex gap-4">
                    <div class="mb-3 w-100">
                        ...
                        <select id="department_code" class="form-select @error('department_code') is-invalid @enderror" name="department_code">
                            ...
                            <option value="{{ $department->code }}" {{ old('department_code') == $department->code ? 'selected' : '' }}>
                                {{ $department->name }}
                            </option>
                            @endforeach
                        </select>
