...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl grow container-p-y">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 order-1 mb-4 mb-lg-0">
                ...
                <div class="col-md-6 col-lg-4 order-2 mb-4 mb-lg-0">
                    <div class="card h-100">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4 mb-lg-0">
                    <div class="card h-100">
